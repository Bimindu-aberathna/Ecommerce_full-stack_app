...
export function WarningBanner() {
    ...
    // Return null if banner should be hidden
    if (!isVisible) {
        return null;
    }
    ...
    return (
      <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          <div className="text-sm/6 text-gray-100">
            <strong className="font-semibold">Bimindu Aberathna Personal Project</strong>
            <svg viewBox="0 0 2 2" aria-hidden="true" className="mx-2 inline size-0.5 fill-current">
              <circle r={1} cx={1} cy={1} />
            </svg>
            <p className="inline !text-red-500">
              This site is a personal project and not a real e-commerce store. All products, prices, and transactions are fictional and for demonstration purposes only.
            </p>
          </div>
          <a
            href="#"
          ...
          >
            Do not Order <span aria-hidden="true"></span>
          </a>
        </div>
